...
| [`orcd-scheduling-2026-09-08.md`](orcd-scheduling-2026-09-08.md) | where model-backed work spends time and memory on ORCD: per-call fixed cost, what a persistent worker would save, and which backends should not hold a GPU |
...
| [`hints-and-routing-2026-09-15.md`](hints-and-routing-2026-09-15.md) | what a declaration changes today (nothing, and nothing it would change with the map populated), what the ruleset routed, and what each gate read while doing it — 13 b2ai v3.1 recordings across 3 subjects, each run twice, hinted and unhinted; not the single reference recording above |
