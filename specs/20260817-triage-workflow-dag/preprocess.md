...
| AST | 10.24 s (its native frame) | `windows.ast.hop_s` | `windows.ast` |
...
| `windows.ast.default_threshold`, `.label_thresholds`, `.hop_s` | the same for AST, and the hop between its 10.24 s frames; **null** until fitted |
