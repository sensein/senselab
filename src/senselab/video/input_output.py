...
# import shutil
from senselab.utils.file import from_strings_to_files
from senselab.utils.functions import get_common_directory
from senselab.utils.tasks.input_output import read_files_from_disk


def extract_audios_from_local_videos(files: Union[str, List[str]], audio_format: str = 'wav', acodec: str = 'pcm_s16le') -> Dict[str, Any]:
