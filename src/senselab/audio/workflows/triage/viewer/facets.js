...
var SchemaFacets = (function () {
  ...
  FacetModel.prototype.encode = function (name) {
    ...
    var rows = this.rows;
    var terms = [];
    // A null-prototype map, because a term is a value the producer wrote and `constructor` or
    // `__proto__` would otherwise resolve against Object.prototype and be silently mis-coded.
