...
DATA_MAP_PATHS = frozenset(
    {
        ...
        "verdict.gates.EFFORT",
        "verdict.gates.EVENT_ALTERNATION",
        "verdict.gates.EVENT_SERIES",
        "verdict.gates.FREE_RESPONSE",
        "verdict.gates.GLIDE",
        "verdict.gates.ITEM_LIST",
        "verdict.gates.ORDERED_TOKENS",
        "verdict.gates.PER_SENTENCE",
        "verdict.gates.SOUND_COVERAGE",
        "verdict.gates.SUSTAINED",
        "verdict.gates.SYLLABLE_SEQUENCE",
        "verdict.gates.SYLLABLE_TRAIN",
