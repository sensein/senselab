...
**not** through ``scripts/analyze_audio.py --diarization-models``. The guards that
keep a role-label backend out of embedding clustering, out of the identity axis's
