...
def very_low_headroom_check(
    ...
    """
    return get_evaluation(audio_or_path, amplitude_headroom_metric, df) < headroom_threshold
...
def very_high_amplitude_interquartile_range_check(
    ...
    """
    return get_evaluation(audio_or_path, amplitude_interquartile_range_metric, df) > threshold
...
def very_low_amplitude_kurtosis_check(
    ...
    """
    return get_evaluation(audio_or_path, amplitude_kurtosis_metric, df) < threshold
...
def very_low_amplitude_modulation_depth_check(
    ...
    """
    return get_evaluation(audio_or_path, amplitude_modulation_depth_metric, df) < threshold
...
def low_amplitude_modulation_depth_check(
    ...
    """
    depth = get_evaluation(audio_or_path, amplitude_modulation_depth_metric, df)
...
def high_proportion_clipped_check(
    ...
    """
    return get_evaluation(audio_or_path, proportion_clipped_metric, df) > threshold
...
def clipping_present_check(
    ...
    """
    return get_evaluation(audio_or_path, proportion_clipped_metric, df) > 0
...
def completely_silent_check(
    ...
    """
    return get_evaluation(audio_or_path, proportion_silent_metric, df) >= silent_proportion
...
def high_amplitude_skew_magnitude_check(
    ...
    """
    return abs(get_evaluation(audio_or_path, amplitude_skew_metric, df)) > magnitude
...
def high_crest_factor_check(
    ...
    """
    return get_evaluation(audio_or_path, crest_factor_metric, df) >= threshold
...
def very_low_dynamic_range_check(
    ...
    """
    return get_evaluation(audio_or_path, dynamic_range_metric, df) < threshold
...
def very_low_mean_absolute_deviation_check(
    ...
    """
    return get_evaluation(audio_or_path, mean_absolute_deviation_metric, df) < threshold
...
def very_low_peak_snr_from_spectral_check(
    ...
    """
    return get_evaluation(audio_or_path, peak_snr_from_spectral_metric, df) < threshold
...
def low_peak_snr_from_spectral_check(
    ...
    """
    snr = get_evaluation(audio_or_path, peak_snr_from_spectral_metric, df)
...
def low_phase_correlation_check(
    ...
    """
    return get_evaluation(audio_or_path, phase_correlation_metric, df) < threshold
...
def high_proportion_silence_at_beginning_check(
    ...
    """
    return get_evaluation(audio_or_path, proportion_silence_at_beginning_metric, df) > threshold
...
def high_proportion_silence_at_end_check(
    ...
    """
    return get_evaluation(audio_or_path, proportion_silence_at_end_metric, df) > threshold
...
def very_low_root_mean_square_energy_check(
    ...
    """
    return get_evaluation(audio_or_path, root_mean_square_energy_metric, df) < threshold
...
def low_shannon_entropy_amplitude_check(
    ...
    """
    return get_evaluation(audio_or_path, shannon_entropy_amplitude_metric, df) < threshold
...
def low_signal_variance_check(
    ...
    """
    return get_evaluation(audio_or_path, signal_variance_metric, df) < threshold
...
def low_spectral_gating_snr_check(
    ...
    """
    return get_evaluation(audio_or_path, spectral_gating_snr_metric, df) < threshold
...
def low_zero_crossing_rate_check(
    ...
    """
    return get_evaluation(audio_or_path, zero_crossing_rate_metric, df) < threshold
...
def high_zero_crossing_rate_check(
    ...
    """
    zcr = get_evaluation(audio_or_path, zero_crossing_rate_metric, df)
...
def audio_intensity_positive_check(
    ...
    """
    return get_evaluation(audio_or_path, dynamic_range_metric, df) > 0
