...
if os.getenv("GITHUB_ACTIONS") != "true":
    ...
    def mars5_model() -> TorchModel:
        ...
        return HFModel(path_or_uri="Camb-ai/mars5-tts", revision="master")

    def test_synthesize_texts_with_hf_model(hf_model: HFModel) -> None:
        """Test synthesizing texts."""
        # TODO: ADD TESTs WITH MULTIPLE MODELS!!!!
        texts = ["Hello world"]
    ...
    def test_synthesize_texts_with_mars5_model(mars5_model: TorchModel, mono_audio_sample: Audio) -> None:
        """Test synthesizing texts."""
        texts_to_synthesize = ["Hello world"]
        ...
        audios = synthesize_texts(texts=texts_to_synthesize, 
                 target=[[target_audio, target_audio_ground_truth]],
                 model=mars5_model,
                 language=language
        )
    ...
    def test_huggingface_tts_pipeline_factory(hf_model: HFModel, 
                                              device: DeviceType, 
                                              is_device_available: Callable) -> None:
