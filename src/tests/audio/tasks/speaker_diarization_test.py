...
if os.getenv("GITHUB_ACTIONS") != "true":
    ...
    def test_diarize_audios(resampled_mono_audio_sample: Audio, pyannote_model: HFModel) -> None:
    ...
    def test_diarize_audios_with_pyannote(resampled_mono_audio_sample: Audio, pyannote_model: HFModel) -> None:
    ...
    def test_pyannote_pipeline_factory(pyannote_model: HFModel) -> None:
        ...
        def test_diarize_audios_with_pyannote_invalid_sampling_rate(
            mono_audio_sample: Audio, pyannote_model: HFModel
        ) -> None:
        ...
        def test_diarize_stereo_audios_with_pyannote_invalid(
            resampled_stereo_audio_sample: Audio, pyannote_model: HFModel
        ) -> None:
