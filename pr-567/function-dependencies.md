...
| `video.tasks.target_speaker_extraction.extract_target_speakers_from_videos` | core | — | No | Yes (clearvoice) | >=3.11 | >=2.8,<3.0 |
...
| `video.tasks.target_speaker_extraction.extract_target_speakers_from_videos` | 3.11 | venv-managed | clearvoice==0.1.2,torch>=2.0.1,torchaudio>=2.0.2,numpy<2.0,>=1.24.3 | true |
